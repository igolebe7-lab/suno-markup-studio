...
```bash
VITE_API_BASE_URL="https://your-suno-api.onrender.com"
```

For local Vite proxy or same-origin deployment, `VITE_API_BASE_URL` can be empty.
...
VITE_API_BASE_URL exactly matches the Render API origin
```
